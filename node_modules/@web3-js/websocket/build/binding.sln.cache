<Project DefaultTargets="Build" ToolsVersion="2.0" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    <SolutionDir>F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\</SolutionDir>
    <SolutionExt>.sln</SolutionExt>
    <SolutionFileName>binding.sln</SolutionFileName>
    <SolutionName>binding</SolutionName>
    <SolutionPath>F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln</SolutionPath>
  </PropertyGroup>
  <PropertyGroup>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{CDE904DA-4CCE-1175-D746-B2B95539E4EF}">Debug|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{C83ABF4A-10CC-3D7E-7D1E-BFC24D76E8B8}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{CDE904DA-4CCE-1175-D746-B2B95539E4EF}">Release|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{C83ABF4A-10CC-3D7E-7D1E-BFC24D76E8B8}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bufferutil" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  <Target Name="bufferutil:Clean" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Clean="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Clean="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  <Target Name="bufferutil:Rebuild" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Rebuild="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Rebuild="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="F:\PROJECTS\blockchain ethereum\Ethereum and Solidity The Complete Developer%27s Guide\crowdfund\node_modules\%40web3-js\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
